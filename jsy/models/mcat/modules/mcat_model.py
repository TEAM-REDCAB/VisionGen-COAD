...
# --- 핵심 MCAT 분류 모델 ---
class MCAT_Binary(nn.Module):
    def __init__(self, path_input_dim=1536, omic_input_dim=9, d_model=256, dropout=0.25):
        super(MCAT_Binary, self).__init__()
        ...
        # 2. 유전체 인코더 (9 -> 256)
        self.omic_net = SNN_Block(dim1=omic_input_dim, dim2=d_model, dropout=dropout)
